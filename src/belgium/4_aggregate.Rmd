...
Merge the three data.frames in a single *cube*, `be_alientaxa_cube`:
...
```{r save_cube_belgium}
write_tsv(be_alientaxa_cube,
          here::here("data", "processed", "be_alientaxa_cube.tsv"),
          na = ""
)
```
...
write_tsv(taxa, 
          here::here("data", "processed", "be_alientaxa_info.tsv"),
          na = ""
)
```
