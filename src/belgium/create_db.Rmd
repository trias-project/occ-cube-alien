...
```{r unzip_csv}
occ_filename <- paste(key, "occurrence.txt", sep = "_") # 0044021-181108115102211_occurrence.txt
...
Occurrences with the following occurrence status should filtered out as well:
